#!/usr/bin/env bash
# Apereo portlet release preflight + cut script (Maven).
#
# Authoritative procedure — see the Maven release guide:
#   https://uportal-project.github.io/manuals/en/uportal5-manual/developer/maven-release-process.md
# Updates to the release flow should land in that doc first, then mirror here.
