 ...
 */
@Component
@PropertySource("classpath:/properties/aws-credentials.properties")
public class AwsCredentialsConfig implements AWSCredentials {

    @Value("${simplecontentportlet.aws.access-key-id:#{null}}")
    private String accessKeyId;

    @Value("${simplecontentportlet.aws.secret-access-key:#{null}}")
